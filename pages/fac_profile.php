...
<div class="row">
    ...
    <!-- search column ends here --> 
      ...
      <div class="col s12 m8" style="margin-top: 1em;">
        <ul class="tabs">
          <li class="tab col s3"><a class="active" href="#practical">Practicals</a></li>
          <li class="tab col s3"><a href="#assignment">Assignments</a></li>
        </ul>
      </div>

      <div id="practical" class="col s12 m8" >

        <div class="card-panel teal">

          <span class="white-text">Showing last 4 practicals</span>
        ...
        <div class="row">
              ...
              <table class="responsive-table striped">
                ...
                <tbody>          
                  ...
                  $select2_query = $db->query("SELECT * FROM practical WHERE tId='$tId' ORDER BY pDate");
                    ...
                    <tr>
                      ...
                      <?php $sub2_query = $db->query("SELECT * FROM subject WHERE subId='$subId'");

                      while($row2=$sub2_query->fetch_assoc()){
                      ...
                      <td><a class="btn waves-effect waves-light" type="submit" name="Search" href="show_more_prac.php?id=<?php echo $pracId ?>">Show more<i class="material-icons right">send</i></a></td>
      ...
      <div id="assignment" class="col s12 m8" >

        <div class="card-panel teal">

          <span class="white-text">Showing last 4 assignments</span>

        </div><br>

        <div class="row">

          <?php $sub_query2 = $db->query("SELECT * FROM assignment WHERE tId='$tId' ORDER BY subId, assDate"); 
        ...
        <?php
          ...
          ?>
              ...
              <tr>
                ...
                <td><a class="btn-floating btn-large waves-effect waves-light" href="<?php echo "../assignment/".$assFile; ?>"><i class="material-icons right">file_download</i></a></td>
